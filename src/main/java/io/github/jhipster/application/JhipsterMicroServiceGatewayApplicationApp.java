...
@EnableZuulProxy
public class JhipsterMicroServiceGatewayApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMicroServiceGatewayApplicationApp.class);

    private final Environment env;

    public JhipsterMicroServiceGatewayApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMicroServiceGatewayApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMicroServiceGatewayApplicationApp.class);
